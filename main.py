        ...
        if last_prompt:
            ...
            if action in ["generate", "use_history"]:
                ...
                standard_prompt = (
                    ...
                    f"identify: 1) The most relevant academic standard (Common Core, NGSS, or state standard) "
                    f"2) The primary CASEL SEL competency it supports. "
                    f"Format as: 'Academic: [standard]' on first line, 'SEL: [competency]' on second line.\n\n"
                    f"Lesson: {lesson[:500]}..."
                )
            ...
            <div class="text-center mt-4 mb-4">
                ...
                <a href="/download/pdf" class="btn btn-warning me-2">📑 Download as PDF</a>
